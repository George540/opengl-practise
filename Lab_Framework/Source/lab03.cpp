...
int main(int argc, char*argv[])
{
    ...
    while(!glfwWindowShouldClose(window))
    {
		...
		// Draw arm-left
		cubeWorldMatrix = translate(mat4(1.0f), vec3(-1.5f, 2.7f, 0.0f)) * scale(mat4(1.0f), vec3(2.0f, 0.2f, 0.2f));
		glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &cubeWorldMatrix[0][0]);
		glDrawArrays(GL_TRIANGLES, 0, 36);
        ...
        for (int i=0; i<100; ++i)
        {
            for (int j=0; j<100; ++j)
            {
				groundWorldMatrix = translate(mat4(1.0f), vec3(-100.0f + i * 10.0f, 5.0f, -100.0f + j * 10.0f)) * scale(mat4(1.0f), vec3(0.02f, 0.02f, 100.0f));
                ...
                cubeWorldMatrix = translate(mat4(1.0f), vec3(- 100.0f + i * 10.0f, 5.0f, -100.0f + j * 10.0f)) * scale(mat4(1.0f), vec3(1.0f, 10.0f, 1.0f));
                glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &cubeWorldMatrix[0][0]);
                glDrawArrays(GL_TRIANGLES, 0, 36);
                
                cubeWorldMatrix = translate(mat4(1.0f), vec3(- 100.0f + i * 10.0f, 0.55f, -100.0f + j * 10.0f)) * rotate(mat4(1.0f), radians(180.0f), vec3(0.0f, 1.0f, 0.0f)) * scale(mat4(1.0f), vec3(1.1f, 1.1f, 1.1f));
                glUniformMatrix4fv(worldMatrixLocation, 1, GL_FALSE, &cubeWorldMatrix[0][0]);
                glDrawArrays(GL_TRIANGLES, 0, 36);
				*/
            }
...
int createVertexArrayObject()
{
	...
	// grid model
	 vec3 vertexArray2[] = {  // position,                            color
        vec3(-0.5f,-0.5f,-0.5f), vec3(1.0f, 1.0f, 0.0f), //left
        ...
        vec3( 0.5f, 0.5f,-0.5f), vec3(1.0f, 1.0f, 0.0f), // far
        vec3(-0.5f,-0.5f,-0.5f), vec3(1.0f, 1.0f, 0.0f),
        vec3(-0.5f, 0.5f,-0.5f), vec3(1.0f, 1.0f, 0.0f),
        ...
        vec3( 0.5f,-0.5f, 0.5f), vec3(1.0f, 1.0f, 0.0f), // bottom
        vec3(-0.5f,-0.5f,-0.5f), vec3(1.0f, 1.0f, 0.0f),
        vec3( 0.5f,-0.5f,-0.5f), vec3(1.0f, 1.0f, 0.0f),
        ...
        vec3(-0.5f, 0.5f, 0.5f), vec3(1.0f, 1.0f, 0.0f), // near
        vec3(-0.5f,-0.5f, 0.5f), vec3(1.0f, 1.0f, 0.0f),
        vec3( 0.5f,-0.5f, 0.5f), vec3(1.0f, 1.0f, 0.0f),
        ...
        vec3( 0.5f, 0.5f, 0.5f), vec3(1.0f, 1.0f, 0.0f), // right
        vec3( 0.5f,-0.5f,-0.5f), vec3(1.0f, 1.0f, 0.0f),
        vec3( 0.5f, 0.5f,-0.5f), vec3(1.0f, 1.0f, 0.0f),
        ...
        vec3( 0.5f, 0.5f, 0.5f), vec3(1.0f, 1.0f, 0.0f), // top
        vec3( 0.5f, 0.5f,-0.5f), vec3(1.0f, 1.0f, 0.0f),
        vec3(-0.5f, 0.5f,-0.5f), vec3(1.0f, 1.0f, 0.0f),
